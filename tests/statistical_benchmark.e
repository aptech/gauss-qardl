...
qa_q0_robust = qardlRobust(data_q0, 1, 0, tau);
...
qa_q0_hac = qardlHAC(data_q0, 1, 0, tau, 3);
...
qa_q0_hac_auto = qardlHAC(data_q0, 1, 0, tau, 0);
qa_q0_hac_resolved = qardlHAC(data_q0, 1, 0, tau, _qardlAutomaticHACLags(qa_q0_hac_auto.nobs));
...
qa_hetero = qardlX(data_hetero, 1, { 0, 1 }, tau, "hac", 2);
...
ecm_hetero = qardlECMX(data_hetero, 1, { 0, 1 }, tau, "hac", 2);
